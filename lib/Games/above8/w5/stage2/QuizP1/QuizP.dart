...
import 'package:chainage1/Games/above8/w5/stage2/QuizP2/QuizP.dart' as quiz2;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "اي من المعالم الاتية موجود في النعامة ؟";
  final String _correctAnswer = "قلعة الشيخ بوعمامة";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya5/stage2/quizp/quiz1.png';
