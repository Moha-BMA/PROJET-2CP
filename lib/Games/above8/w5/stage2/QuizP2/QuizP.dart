...
import 'package:chainage1/Games/above8/w5/stage2/Quiz/QuizQ.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما اسم الشجرة التي تمت تحتها مبايعة الامير عبد القادر؟";
  final String _correctAnswer = "الدردارة";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya5/stage2/quizp/quiz2.png';
