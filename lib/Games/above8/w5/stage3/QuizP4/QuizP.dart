...
import 'package:chainage1/Games/above8/w5/stage3/Puzzle/JigsawPuzzleScreen.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "اين تقع هذه النقوش؟";
  final String _correctAnswer = "كهوف فينيزارا";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya5/stage3/quizp/quiz4.jpg';
