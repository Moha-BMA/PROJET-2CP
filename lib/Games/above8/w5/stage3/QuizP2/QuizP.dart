...
import 'package:chainage1/Games/above8/w5/stage3/QuizP3/QuizP.dart' as quiz3;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما اسم القلعة التي بناها البرتغاليون في تندوف؟";
  final String _correctAnswer = "قلعة البرتغاليين";
  final List<String> _incorrectAnswers = [
    "قلعة بني حماد",
    " قلعة بابا عروج",
    "قلعة الأمير عبد القادر"
  ];
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya5/stage3/quizp/quiz2.jpeg';
