...
import 'package:chainage1/Games/above8/w5/stage3/QuizP4/QuizP.dart' as quiz4;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما اسم الفوهة البركانية قرب تندوف؟";
  final String _correctAnswer = "بركان أوركزيز";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya5/stage3/quizp/quiz3.jpg';
