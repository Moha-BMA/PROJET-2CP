...
import 'package:chainage1/Games/above8/w5/stage3/QuizP2/QuizP.dart' as quiz2;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أين تقع الكثبان الرملية بعرق إيڨيدي؟";
  final String _correctAnswer = "ولاية تندوف";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya5/stage3/quizp/quiz1.jpg';
