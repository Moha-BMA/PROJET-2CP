...
import 'package:chainage1/Games/above8/w5/stage4/QuizP3/QuizP.dart' as quiz3;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أين يقع قصر الدراع؟";
  final String _correctAnswer = "ولاية أدرار";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya5/stage4/quizp/quiz2.jpeg';
