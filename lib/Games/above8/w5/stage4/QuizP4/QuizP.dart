import 'package:chainage1/MBGames/Above8/1/Quiz/QuizQ.dart';
import 'package:flutter/material.dart';
import 'package:chainage1/Games/above8/w5/stage4/FlipCard/GameManager.dart';
import 'dart:math';
import 'dart:async';
import 'package:chainage1/Games/above8/w5/stage4/Settings.dart';// Import for timer functionality
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما النظام الذي أنشأه سكان الصحراء لتوزيع المياه؟";
  final String _correctAnswer = "الفوجارات";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya5/stage4/quizp/quiz4.jpg';
