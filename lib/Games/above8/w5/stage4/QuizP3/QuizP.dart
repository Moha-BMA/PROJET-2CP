...
import 'package:chainage1/Games/above8/w5/stage4/QuizP4/QuizP.dart' as quiz4;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أي من القصور التالية معلم تاريخي في أدرار؟";
  final String _correctAnswer = "قصر تماسخت";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya5/stage4/quizp/quiz3.jpeg';
