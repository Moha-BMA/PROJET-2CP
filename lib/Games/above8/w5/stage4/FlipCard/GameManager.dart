...
import 'package:chainage1/Games/above8/w5/stage4/loading4.dart';
import 'package:chainage1/Games/above8/w5/stage4/Settings.dart';
import 'dart:math';
import 'dart:async';
import 'flipcard.dart';
import 'package:chainage1/card+gameplay/Card_Screen.dart';
import 'package:chainage1/app_state.dart';
import 'package:chainage1/Wilayas_stages/above 8/w5/stage_screen5.dart';
...
class _MemoryGameState extends ConsumerState<MemoryGame> with SingleTickerProviderStateMixin {
  ...
  void _initializeGame() {
    List<CardData> pairs = [
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya5/stage4/flipcard/1.jpeg', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya5/stage4/flipcard/1.jpeg', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya5/stage4/flipcard/2.jpeg', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya5/stage4/flipcard/2.jpeg', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya5/stage4/flipcard/3.jpg', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya5/stage4/flipcard/3.jpg', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya5/stage4/flipcard/4.jpeg', pairId: 4),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya5/stage4/flipcard/4.jpeg', pairId: 4),
    ];
  ...
  void _saveGameResults() {
    try {
      ...
      int previousStars = prefs.getInt('W5_stage4_stars') ?? 0;

      if (earnedStars > previousStars) {
        prefs.setInt('W5_stage4_stars', earnedStars);
        ref.read(w5Stage4StarsProvider.notifier).state = earnedStars;
        prefs.setBool('W5_stage4_completed', true);

        int currentProgress = prefs.getInt('S_wilaya5') ?? 1;
        ...
        print("Stage completion saved: Wilaya 5, Stage 4 - $earnedStars stars");
      } else {
        prefs.setBool('W5_stage4_completed', true);
      }
  ...
  Widget build(BuildContext context) {
    ...
    onTap: () async {
    final prefs = ref.read(sharedPreferencesProvider);
    await prefs.setBool('W5_stage4_next_pressed', true);
    setState(() {
    _isTrophyContainerVisible = false;
    ...
    children: [
    SizedBox(height: MediaQuery.of(context).size.height * 0.05),AnimatedBuilder(
        animation: _controller,
        builder: (context, child) {
          return Transform.scale(
            scale: _scaleAnimation.value,
            child: Image.asset(
              'assets/assetsTrophyspace/images/trophy5_col.png',
              width: 200,
              height: 300,
              fit: BoxFit.contain,
            ),
  ...
  void initState() {
    ...
    _scaleAnimation = Tween(begin: 0.1, end: 1.0).animate(
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _isFirstNextPress = !(prefs.getBool('W5_stage4_next_pressed') ?? false);
      _startTimer();
    });
  }
  ...
  void startNextGame() {
    Navigator.of(context).pushAndRemoveUntil(
      MaterialPageRoute(builder: (context) => StageScreen5()),
          (route) => false,
    );
  }
