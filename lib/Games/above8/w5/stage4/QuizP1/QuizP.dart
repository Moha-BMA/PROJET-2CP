...
import 'package:chainage1/Games/above8/w5/stage4/QuizP2/QuizP.dart' as quiz2;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما هو القصر التقليدي المشهور في أدرار؟";
  final String _correctAnswer = "قصر إغزر";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya5/stage4/quizp/quiz1.jpg';
