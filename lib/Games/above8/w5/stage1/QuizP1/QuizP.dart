...
import 'package:chainage1/Games/above8/w5/stage1/QuizP2/QuizP.dart' as quiz2;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  final String _correctAnswer = "قلعة سانتا كروز ";
  final List<String> _incorrectAnswers = [
    "الحديقة الوطنية الحامة",
    " مسجد عقبة بن نافع",
    " تيمقاد"
  ];
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya5/stage1/quizp/quiz1.png';
