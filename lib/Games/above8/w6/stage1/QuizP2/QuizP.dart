...
import 'package:chainage1/Games/above8/w6/stage1/FlipCard/GameManager.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " ما اسم هذا الموقع؟";
  final String _correctAnswer = "تادرارت الحمراء";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya6/stage1/quizp/quizp2.jpg';
