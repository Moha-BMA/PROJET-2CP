...
import 'package:chainage1/Games/above8/w6/stage3/Settings.dart';
import 'dart:math';
import 'dart:async';
import 'flipcard.dart';
import 'package:chainage1/card+gameplay/Card_Screen.dart';
import 'package:chainage1/app_state.dart';
import 'package:chainage1/Wilayas_stages/above%208/w6/stage_screen6.dart';
...
class _MemoryGameState extends ConsumerState<MemoryGame> with SingleTickerProviderStateMixin {
  ...
  void _initializeGame() {
    List<CardData> pairs = [
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya6/stage3/flipcard/1.jpg', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya6/stage3/flipcard/1.jpg', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya6/stage3/flipcard/2.jpg', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya6/stage3/flipcard/2.jpg', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya6/stage3/flipcard/3.jpg', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya6/stage3/flipcard/3.jpg', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya6/stage3/flipcard/4.jpg', pairId: 4),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya6/stage3/flipcard/4.jpg', pairId: 4),
    ];
  ...
  void _saveGameResults() {
    try {
      ...
      int previousStars = prefs.getInt('W6_stage3_stars') ?? 0;

      if (earnedStars > previousStars) {
        prefs.setInt('W6_stage3_stars', earnedStars);
        ref.read(w6Stage3StarsProvider.notifier).state = earnedStars;
        prefs.setBool('W6_stage3_completed', true);
        ...
        print("Stage completion saved: Wilaya 6, stage 3 - $earnedStars stars");
      } else {
        prefs.setBool('W6_stage3_completed', true);
      }
        ...
        children: [
          ...
          if (_isTrophyContainerVisible)
            GestureDetector(
              onTap: () async {
                final prefs = ref.read(sharedPreferencesProvider);
                await prefs.setBool('W6_stage3_next_pressed', true);
                setState(() {
                  _isTrophyContainerVisible = false;
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            return Transform.scale(
                              ...
                              child: Image.asset(
                                'assets/assetsTrophyspace/images/trophy6_col.png',
                                width: 200,
                                height: 300,
                                fit: BoxFit.contain,
                              ),
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _isFirstNextPress = !(prefs.getBool('W6_stage3_next_pressed') ?? false);
      _startTimer();
    });
  }
