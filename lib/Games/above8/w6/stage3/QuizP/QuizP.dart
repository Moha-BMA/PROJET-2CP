...
import 'package:chainage1/Games/above8/w6/stage3/FlipCard/GameManager.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "اين يقع هذا المعلم السياحي ؟";
  final String _correctAnswer = "المسيلة";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya6/stage3/quizp/quizp.png';
