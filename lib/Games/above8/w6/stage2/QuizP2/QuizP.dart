...
import 'package:chainage1/Games/above8/w6/stage2/Quiz/QuizQ.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما اسم هذا المعلم السياحي ؟";
  final String _correctAnswer = " قصر ورقلة";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya6/stage2/quizp/quizp2.jpg';
