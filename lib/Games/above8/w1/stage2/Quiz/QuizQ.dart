import 'package:chainage1/Games/above8/w1/stage2/FlipCard/GameManager.dart';
...
class QuizQ extends StatefulWidget {
  ...
  const QuizQ({Key? key, this.previousTimeInSeconds = 0}) : super(key: key);
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  Stopwatch _stopwatch = Stopwatch(); // To track elapsed time
  ...
  // Question info
  final String _question = "في أي ولاية يقع حمام الصالحين؟";
  final String _correctAnswer = "خنشلة";
  ...
  // City name
  final String _cityName = "الولاية 1";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final startX=screenWidth*0.02;
          final startY=screenHeight*0.02;
          return Stack(
            fit: StackFit.expand,
            children: [
              // Background Image
              ...
              // Timer Display (Current Question) - positioned to the right of the question
             /* Positioned(
                top: screenHeight * 0.3, // Same level as the question
                right: screenWidth * 0.2, // To the right of the question
                child: Container(
              ...
              // Total Timer Display (If we have previous time) - positioned in the middle of the left side
              if (widget.previousTimeInSeconds > 0)
                Positioned(
                  top: screenHeight * 0.35, // Middle of the left side
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => MemoryGame(
                                        ...
                                        previousTimeInSeconds: _totalTimeInSeconds,
                                      ),
                                    ),
                                  );
                                });
             ...
             /* if (_showSettings)
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Image.asset(
                                  'assets/assetsQuiz/assetsQuizQ/icons/settings.png',
                                  width: 150,
                                  height: 150,
                                ),
                                SizedBox(height: 20),
              ...
              if (_showHint)
                Positioned.fill(
                  child: GestureDetector(
                    onTap: _toggleHint, // Close when tapping outside
                    child: Container(
                      color: Colors.black54,
                      child: Center(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Image.asset(
                                  'assets/assetsQuiz/assetsQuizQ/icons/hints.png',
                                  width: 100,
                                  height: 100,
                                ),
                                SizedBox(height: 20),
