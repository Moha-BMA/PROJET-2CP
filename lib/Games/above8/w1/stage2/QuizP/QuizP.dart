...
import 'package:chainage1/Games/above8/w1/stage2/Quiz/QuizQ.dart';
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أين يقع هذا المعلم الأثري  ؟";
  final String _correctAnswer = "تيمغاد";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya1/stage2/quizp/quizp.jpg';
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Image.asset(
                                  'assets/assetsQuiz/assetsQuizP/icons/hints.png',
                                  width: 100,
                                  height: 100,
                                ),
                                SizedBox(height: 20),
