...
import 'package:chainage1/Games/above8/w1/stage3/Quiz/QuizQ.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " أين يقع هذا المعلم ؟؟";
  final String _correctAnswer = "بسكرة";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya1/stage3/quizp/quizp.jpg';
