...
import 'package:chainage1/Games/above8/w1/stage1/Quiz/QuizQ.dart';
...
class QuizP extends StatefulWidget {
  ...
  const QuizP({Key? key, this.previousTimeInSeconds = 0}) : super(key: key);
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أي من المعالم الآتية في الصورة؟";
  final String _correctAnswer = "قوس كراكالا";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya1/stage1/quizp/quizp.png';
