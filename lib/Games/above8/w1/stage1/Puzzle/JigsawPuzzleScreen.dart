import 'dart:math';
import 'package:chainage1/Games/above8/w1/stage1/Settings.dart';
...
class _JigsawPuzzleScreenState extends ConsumerState<JigsawPuzzleScreen> {
  final String puzzleImage = 'assets/assetsgamesunderabove/above8/wilaya1/stage1/puzzle/puzzle_image.png';
    ...
    for (int row = 0; row < rows; row++) {
      for (int col = 0; col < columns; col++) {
        ...
        PuzzlePiece piece = PuzzlePiece(
          id: index,
          imageProvider: AssetImage('assets/assetsgamesunderabove/above8/wilaya1/stage1/puzzle/puzzle_piece_${index + 1}.png'),
