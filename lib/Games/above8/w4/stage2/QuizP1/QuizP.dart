...
import 'package:chainage1/Games/above8/w4/stage2/QuizP2/QuizP.dart' as quiz2;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما اسم هذه البحيرة في المدية؟";
  final String _correctAnswer = " بحيرة الضاية";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya4/stage2/quizp/quiz1.png';
