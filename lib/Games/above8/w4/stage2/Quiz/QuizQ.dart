import 'package:chainage1/Games/above8/w4/stage2/FlipCard/GameManager.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " بماذا يعرف جبل تيكجدة ؟";
  final String _correctAnswer = "الغابات و الثلج";
  ...
  // City name
  final String _cityName = "الولاية 4";
