...
import 'package:chainage1/Games/above8/w4/stage2/loading2.dart';
import 'package:chainage1/Games/above8/w4/stage2/Settings.dart';
import 'dart:math';
import 'dart:async';
import 'flipcard.dart';
import 'package:chainage1/card+gameplay/Card_Screen.dart';
import 'package:chainage1/app_state.dart';
import 'package:chainage1/Wilayas_stages/above%208/w4/stage_screen4.dart';
...
class _MemoryGameState extends ConsumerState<MemoryGame> with SingleTickerProviderStateMixin {
  ...
  void _initializeGame() {
    List<CardData> pairs = [
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya4/stage2/flipcard/1.png', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya4/stage2/flipcard/1.png', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya4/stage2/flipcard/2.png', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya4/stage2/flipcard/2.png', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya4/stage2/flipcard/3.png', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya4/stage2/flipcard/3.png', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya4/stage2/flipcard/4.png', pairId: 4),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya4/stage2/flipcard/4.png', pairId: 4),
    ];
  ...
  void _saveGameResults() {
    try {
      ...
      int previousStars = prefs.getInt('W4_stage2_stars') ?? 0;

      if (earnedStars > previousStars) {
        prefs.setInt('W4_stage2_stars', earnedStars);
        ref.read(w4Stage2StarsProvider.notifier).state = earnedStars;
        prefs.setBool('W4_stage2_completed', true);

        int currentProgress = prefs.getInt('S_wilaya4') ?? 1;
        if (currentProgress < 3 && earnedStars > 0) {
          prefs.setInt('S_wilaya4', 3);
          ref.read(wilaya4ProgressProvider.notifier).state = 3;
        }

        final starsNotifier = ref.read(starsProvider.notifier);
        starsNotifier.addStars(earnedStars - previousStars);

        print("Stage completion saved: Wilaya 4, Stage 2 - $earnedStars stars");
      } else {
        prefs.setBool('W4_stage2_completed', true);
      }
        ...
        children: [
          ...
          if (_isTrophyContainerVisible)
            GestureDetector(
              onTap: () async {
                final prefs = ref.read(sharedPreferencesProvider);
                await prefs.setBool('W4_stage2_next_pressed', true);
                setState(() {
                  _isTrophyContainerVisible = false;
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            return Transform.scale(
                              ...
                              child: Image.asset(
                                'assets/assetsTrophyspace/images/trophy4_col.png',
                                width: 200,
                                height: 300,
                                fit: BoxFit.contain,
                              ),
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _isFirstNextPress = !(prefs.getBool('W4_stage2_next_pressed') ?? false);
      _startTimer();
    });
  }
  ...
  void startNextGame() {
    Navigator.of(context).pushAndRemoveUntil(
      MaterialPageRoute(builder: (context) => StageScreen4()),
          (route) => false,
    );
  }
