...
import 'package:chainage1/Games/above8/w4/stage2/Quiz/QuizQ.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " أين يقع جبل تيكجدة   ؟";
  final String _correctAnswer = "البويرة";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya4/stage2/quizp/quiz2.png';
