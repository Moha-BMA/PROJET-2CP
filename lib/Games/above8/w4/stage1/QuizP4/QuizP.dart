...
import 'package:chainage1/Games/above8/w4/stage1/Quiz/QuizQ.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما اسم هذا المسجد ؟";
  final String _correctAnswer = "المسجد الأعظم";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya4/stage1/quizp/quiz4.jpg';
