...
import 'package:chainage1/Games/above8/w4/stage1/QuizP2/QuizP.dart' as quiz2;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " مااسم الحديقة النباتية الموجودة في العاصمة؟";
  final String _correctAnswer = " حديقة التجارب ";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya4/stage1/quizp/quiz1.jpg';
