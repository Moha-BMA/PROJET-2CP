...
import 'package:chainage1/Games/above8/w4/stage1/QuizP4/QuizP.dart' as quiz4;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما اسم هذا الحي القديم في العاصمة ؟";
  final String _correctAnswer = "القصبة ";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya4/stage1/quizp/quiz3.jpg';
