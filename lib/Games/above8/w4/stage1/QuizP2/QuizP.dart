...
import 'package:chainage1/Games/above8/w4/stage1/QuizP3/QuizP.dart' as quiz3;
import 'dart:math';
import 'dart:async';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "كم يبلغ ارتفاع مقام الشهيد ؟";
  final String _correctAnswer = "92 متر ";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath = 'assets/assetsgamesunderabove/above8/wilaya4/stage1/quizp/quiz2.jpg';
