...
import 'package:chainage1/Games/above8/w2/stage2/Quiz/QuizQ.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أين تقع شلالات أفنسو  ؟";
  final String _correctAnswer = "سكيكدة";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya2/stage2/quizp/quiz1.png';
