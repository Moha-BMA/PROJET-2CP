...
import 'package:chainage1/Games/above8/w2/stage1/Quiz/QuizQ.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ماذا يمثل هذا المعلم السياحي ؟";
  final String _correctAnswer = " جسر سيدي مسيد";
  ...
  // Hint text
  final String _hintText = "هذا المعلم يقع على تل مرتفع ";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya2/stage1/quizp/quiz1.jpg';
