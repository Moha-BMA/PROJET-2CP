import 'package:chainage1/Games/above8/w2/stage1/Puzzle/JigsawPuzzleScreen.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " أين تقع المغارة التي تحتوي على صواعد وهوابط؟";
  final String _correctAnswer = "جيجل ";
  ...
  // City name
  final String _cityName = "الولاية 2";
