...
import 'package:chainage1/Games/above8/w3/stage1/Quiz/QuizQ.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أين تقع الأثار الرومانية في الصورة";
  final String _correctAnswer = "تيزي وزو";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya3/stage1/quizp/quizp.jpg';
