import 'package:chainage1/Games/above8/w3/stage1/Puzzle/JigsawPuzzleScreen.dart';
import 'package:flutter/material.dart';
import 'dart:math';
import 'dart:async'; // Import for timer functionality
import 'package:chainage1/Games/above8/w3/stage1/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أي من المعالم الطبيعية الآتية تقع في بومرداس؟";
  final String _correctAnswer = "سد قدارة";
  ...
  // City name
  final String _cityName = "الولاية 3";
