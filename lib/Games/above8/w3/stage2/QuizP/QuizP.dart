...
import 'package:chainage1/Games/above8/w3/stage2/Quiz/QuizQ.dart';
import 'dart:math';
...
class _QuizPState extends State<QuizP> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " أين تقع هذه البحيرة ؟";
  final String _correctAnswer = "بجاية";
    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final String imagepath='assets/assetsgamesunderabove/above8/wilaya3/stage2/quizp/quizp.jpg';
