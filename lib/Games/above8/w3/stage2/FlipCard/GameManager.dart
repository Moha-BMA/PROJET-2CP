...
import 'package:chainage1/Games/above8/w3/stage2/Settings.dart';
import 'dart:math';
import 'dart:async';
import 'flipcard.dart';
import 'package:chainage1/card+gameplay/Card_Screen.dart';
import 'package:chainage1/app_state.dart';
import 'package:chainage1/Wilayas_stages/above%208/w3/stage_screen3.dart';
...
class _MemoryGameState extends ConsumerState<MemoryGame> with SingleTickerProviderStateMixin {
  ...
  void _initializeGame() {
    List<CardData> pairs = [
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya3/stage2/flipcard/1.jpg', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya3/stage2/flipcard/1.jpg', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya3/stage2/flipcard/2.jpg', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya3/stage2/flipcard/2.jpg', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya3/stage2/flipcard/3.jpg', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya3/stage2/flipcard/3.jpg', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya3/stage2/flipcard/4.jpg', pairId: 4),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/above8/wilaya3/stage2/flipcard/4.jpg', pairId: 4),
    ];
  ...
  void _saveGameResults() {
    try {
      ...
      if (earnedStars > previousStars) {
        prefs.setInt('W3_stage2_stars', earnedStars);
        ref.read(w3Stage2StarsProvider.notifier).state = earnedStars;
        prefs.setBool('W3_stage2_completed', true);

        int currentProgress = prefs.getInt('S_wilaya3') ?? 1;
        if (currentProgress < 3 && earnedStars > 0) {
          prefs.setInt('S_wilaya3', 3);
          ref.read(wilaya3ProgressProvider.notifier).state = 3;
        }

        final starsNotifier = ref.read(starsProvider.notifier);
        starsNotifier.addStars(earnedStars - previousStars);

        print("Stage completion saved: Wilaya 3, Stage 2 - $earnedStars stars");
      } else {
        prefs.setBool('W3_stage2_completed', true);
      }
