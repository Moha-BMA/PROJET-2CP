import 'dart:math';
import 'package:chainage1/Games/under7/w2/stage1/loading1.dart';
...
class _JigsawPuzzleScreenState extends ConsumerState<JigsawPuzzleScreen> {
  final String puzzleImage = 'assets/assetsgamesunderabove/under7/wilaya2/stage1/puzzle/puzzle_image.png';
    ...
    for (int row = 0; row < rows; row++) {
      for (int col = 0; col < columns; col++) {
        ...
        PuzzlePiece piece = PuzzlePiece(
          id: index,
          imageProvider: AssetImage('assets/assetsgamesunderabove/under7/wilaya2/stage1/puzzle/puzzle_piece_${index + 1}.png'),
    ...
    try {
      ...
      if (totalStarsEarned > previousStars) {
        ...
        if (currentProgress < 2 && totalStarsEarned > 0) {
          await prefs.setInt('S_wilaya2', 2); // Unlock stage 2
        }
