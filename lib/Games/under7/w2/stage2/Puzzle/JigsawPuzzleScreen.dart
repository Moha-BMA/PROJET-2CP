import 'dart:math';
import 'package:chainage1/Games/under7/w2/stage2/loading2.dart';
...
class _JigsawPuzzleScreenState extends ConsumerState<JigsawPuzzleScreen> with SingleTickerProviderStateMixin {
  final String puzzleImage = 'assets/assetsgamesunderabove/under7/wilaya2/stage2/puzzle/puzzle_image.png';
    ...
    for (int row = 0; row < rows; row++) {
      for (int col = 0; col < columns; col++) {
        ...
        PuzzlePiece piece = PuzzlePiece(
          id: index,
          imageProvider: AssetImage('assets/assetsgamesunderabove/under7/wilaya2/stage2/puzzle/puzzle_piece_${index + 1}.png'),
  ...
  void saveStageCompletion() async {
    try {
      ...
      if (totalStarsEarned > previousStars) {
        await prefs.setInt('W2_stage2_stars', totalStarsEarned);
        await prefs.setBool('W2_stage2_completed', true);
        ...
        print("Stage completion saved: Wilaya 2, Stage 2 - $totalStarsEarned stars");
      } else {
        await prefs.setBool('W2_stage2_completed', true);
      }
    } catch (e) {
