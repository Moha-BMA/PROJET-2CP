...
import 'package:chainage1/Games/under7/w4/stage1/FlipCard/GameManager.dart';
import 'dart:async';
import 'package:video_player/video_player.dart';
class LoadingScreen1 extends StatefulWidget {
  final Widget nextScreen=MemoryGame();
  ...
  @override
  State<LoadingScreen1> createState() => _LoadingScreenState();
}

class _LoadingScreenState extends State<LoadingScreen1> {
...
class _VideoScreenState extends State<VideoScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/videos/wilayas/w4/stage1.mp4')
      ..initialize().then((_) {
        setState(() {});
    ...
    _transitionController.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        Navigator.of(context).pushReplacement(
          PageRouteBuilder(
            pageBuilder: (context, animation, secondaryAnimation) => MemoryGame(),
