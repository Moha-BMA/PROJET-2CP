...
class _JigsawPuzzleScreenState extends ConsumerState<JigsawPuzzleScreen> {
  final String puzzleImage = 'assets/assetsgamesunderabove/under7/wilaya5/stage2/puzzle/puzzle_image.jpeg';
    ...
    for (int row = 0; row < rows; row++) {
      for (int col = 0; col < columns; col++) {
        ...
        PuzzlePiece piece = PuzzlePiece(
          id: index,
          imageProvider: AssetImage('assets/assetsgamesunderabove/under7/wilaya5/stage2/puzzle/puzzle_piece_${index + 1}.jpg'),
    ...
    try {
      ...
      if (totalStarsEarned > previousStars) {
        ...
        if (currentProgress < 2 && totalStarsEarned > 0) {
          await prefs.setInt('S_wilaya5', 2); // Unlock stage 2
        }
