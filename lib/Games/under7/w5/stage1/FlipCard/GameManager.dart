...
import 'package:chainage1/Games/under7/w5/stage1/Puzzle/JigsawPuzzleScreen.dart';
import 'dart:async';
import 'package:chainage1/Wilayas_stages/under 7/w5/stage_screen5.dart';
import 'package:chainage1/app_state.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:chainage1/Games/under7/w5/stage1/Settings.dart';
...
class _MemoryGameState extends ConsumerState<MemoryGame> {
  ...
  void _initializeGame() {
    ...
    List<CardData> pairs = [
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/under7/wilaya5/stage1/flipcard/1.png', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/under7/wilaya5/stage1/flipcard/1.png', pairId: 1),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/under7/wilaya5/stage1/flipcard/2.png', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/under7/wilaya5/stage1/flipcard/2.png', pairId: 2),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/under7/wilaya5/stage1/flipcard/3.png', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/under7/wilaya5/stage1/flipcard/3.png', pairId: 3),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/under7/wilaya5/stage1/flipcard/4.png', pairId: 4),
      CardData(frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png', backImage: 'assets/assetsgamesunderabove/under7/wilaya5/stage1/flipcard/4.png', pairId: 4),
    ];
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.swap_horiz, color: Color(0xFF522C0B)),
                  SizedBox(width: 5),
                  Text(
                    "$_moves",
                    style: TextStyle(
