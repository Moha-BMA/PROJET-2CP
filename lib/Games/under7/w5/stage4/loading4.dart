...
import 'package:chainage1/Games/under7/w5/stage4/FlipCard/GameManager.dart';
import 'dart:async';
...
class LoadingScreen4 extends StatefulWidget {
  ...
  @override
  State<LoadingScreen4> createState() => _LoadingScreenState();
}

class _LoadingScreenState extends State<LoadingScreen4> {
...
class _VideoScreenState extends State<VideoScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/videos/wilayas/w5/stage4.mp4')
      ..initialize().then((_) {
        setState(() {});
