...
import 'package:chainage1/Games/under7/w1/stage2/FlipCard/GameManager.dart';
import 'dart:async';
...
class LoadingScreen2 extends StatefulWidget {
  ...
  @override
  State<LoadingScreen2> createState() => _LoadingScreenState();
}
...
class _VideoScreenState extends State<VideoScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/videos/wilayas/w1/stage2.mp4')
      ..initialize().then((_) {
        setState(() {});
