...
import 'package:chainage1/Games/under7/w1/stage2/loading2.dart';
...
class _JigsawPuzzleScreenState extends ConsumerState<JigsawPuzzleScreen> {
  final String puzzleImage = 'assets/assetsgamesunderabove/under7/wilaya1/stage2/puzzle/puzzle_image.png';
    ...
    for (int row = 0; row < rows; row++) {
      for (int col = 0; col < columns; col++) {
        ...
        PuzzlePiece piece = PuzzlePiece(
          id: index,
          imageProvider: AssetImage('assets/assetsgamesunderabove/under7/wilaya1/stage2/puzzle/puzzle_piece_${index + 1}.png'),
  ...
  void saveStageCompletion() async {
    try {
      ...
      if (totalStarsEarned > previousStars) {
        ...
        await prefs.setInt('W1_stage2_stars', totalStarsEarned);

        // Mark stage as completed
        await prefs.setBool('W1_stage2_completed', true);
        ...
        print("Stage completion saved: Wilaya 1, Stage 2 - $totalStarsEarned stars");
      } else {
