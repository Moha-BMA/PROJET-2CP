import 'dart:math';
import 'package:chainage1/Games/under7/w1/stage3/loading3.dart';
import 'package:chainage1/Wilayas_stages/under 7/w1/stage_screen1.dart';
import 'package:flutter/material.dart';
import 'package:chainage1/Games/under7/w1/stage3/Settings.dart';
import 'dart:async';
...
class _JigsawPuzzleScreenState extends ConsumerState<JigsawPuzzleScreen> with SingleTickerProviderStateMixin {
  final String puzzleImage = 'assets/assetsgamesunderabove/under7/wilaya1/stage3/puzzle/puzzle_image.png';
  ...
  bool _showGameCompletion = false; // Renamed from _showAwardTemplate to match above8
    ...
    for (int row = 0; row < rows; row++) {
      for (int col = 0; col < columns; col++) {
        ...
        PuzzlePiece piece = PuzzlePiece(
          id: index,
          imageProvider: AssetImage('assets/assetsgamesunderabove/under7/wilaya1/stage3/puzzle/puzzle_piece_${index + 1}.png'),
