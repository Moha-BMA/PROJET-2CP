...
class OpenedStageGroup4 extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OpenedStageGroup4> createState() => _OpenedStageGroup4();
}

class _OpenedStageGroup4 extends ConsumerState<OpenedStageGroup4> {
  int _visibleStars = 0;
  ...
  @override
  void didUpdateWidget(OpenedStageGroup4 oldWidget) {
          ...
          switch (widget.stageNumber) {
            case 1:
              Navigator.push(
                ...
                int updatedStars = prefs.getInt('W4_stage1_stars') ?? widget.starstate;
                if (updatedStars != widget.starstate) {
                  ref.invalidate(w4Stage1StarsProvider);
                }
              });
              break;
            case 2:
              Navigator.push(
                ...
                final prefs = ref.read(sharedPreferencesProvider);
                int updatedStars = prefs.getInt('W4_stage2_stars') ?? widget.starstate;
                if (updatedStars != widget.starstate) {
                  ref.invalidate(w4Stage2StarsProvider);
                }
              });
              break;
            default:
