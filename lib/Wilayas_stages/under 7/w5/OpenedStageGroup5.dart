...
import 'package:chainage1/Games/under7/w5/stage1/loading1.dart';
import 'package:chainage1/Games/under7/w5/stage2/loading2.dart';
import 'package:chainage1/Games/under7/w5/stage3/loading3.dart';
import 'package:chainage1/Games/under7/w5/stage4/loading4.dart';
import 'package:flutter/material.dart';

import 'package:chainage1/app_state.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
class OpenedStageGroup5 extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OpenedStageGroup5> createState() => _OpenedStageGroup5();
}

class _OpenedStageGroup5 extends ConsumerState<OpenedStageGroup5> {
  int _visibleStars = 0;
  ...
  @override
  void didUpdateWidget(OpenedStageGroup5 oldWidget) {
          ...
          switch (widget.stageNumber) {
            case 1:
              Navigator.push(
                ...
                int updatedStars = prefs.getInt('W5_stage1_stars') ?? widget.starstate;
                if (updatedStars != widget.starstate) {
                  ref.invalidate(w5Stage1StarsProvider);
                }
              });
              break;
            case 2:
              Navigator.push(
                ...
                final prefs = ref.read(sharedPreferencesProvider);
                int updatedStars = prefs.getInt('W5_stage2_stars') ?? widget.starstate;
                if (updatedStars != widget.starstate) {
                  ref.invalidate(w5Stage2StarsProvider);
                }
              });
              break; case 3:
            Navigator.push(
              ...
              final prefs = ref.read(sharedPreferencesProvider);
              int updatedStars = prefs.getInt('W5_stage3_stars') ?? widget.starstate;
              if (updatedStars != widget.starstate) {
                ref.invalidate(w5Stage3StarsProvider);
              }
            });
            break; case 4:
            Navigator.push(
              ...
              final prefs = ref.read(sharedPreferencesProvider);
              int updatedStars = prefs.getInt('W5_stage4_stars') ?? widget.starstate;
              if (updatedStars != widget.starstate) {
                ref.invalidate(w5Stage4StarsProvider);
              }
            });
            break;
            default:
