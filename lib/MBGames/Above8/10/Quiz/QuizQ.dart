...
import 'dart:math';
import 'package:chainage1/MBGames/Above8/10/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "ما يمكن للسائح اكتشافه في الصحراء؟";
  final String _correctAnswer = " الهقار و الطاسيلي ناجر";
