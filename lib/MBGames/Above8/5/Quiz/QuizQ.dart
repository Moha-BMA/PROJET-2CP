...
import 'dart:math';
import 'package:chainage1/MBGames/Above8/5/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "كم مقدار تساقط الامطارالسنوي في الإقليم الشمالي؟";
  final String _correctAnswer = "400-1200 ";
