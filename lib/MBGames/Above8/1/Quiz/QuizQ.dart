...
import 'package:chainage1/MBGames/Above8/1/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "كم تصنف الجزائر مساحة في العالم؟";
  final String _correctAnswer = "العاشرة عالميا";
  final List<String> _incorrectAnswers = [
    "الخامسة و اربعون عالميا",
    "المئة عالميا",
    "الثلاثون عالميا"
  ];
