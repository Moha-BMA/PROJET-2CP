...
import 'dart:math';
import 'package:chainage1/MBGames/Above8/12/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " ماهي نسبة مساحة الصحراء مقارنة بمساحة الجزائر؟";
  final String _correctAnswer = " 80%";
