...
import 'dart:math';
import 'package:chainage1/MBGames/Above8/6/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "لهجة التماشق هي اللهجة المتحدث بها في";
  final String _correctAnswer = " الطوارق";
