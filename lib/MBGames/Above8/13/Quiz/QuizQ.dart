...
import 'dart:math';
import 'package:chainage1/MBGames/Above8/13/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " ما هو أكبر شط (بحيرة مالحة) في الجزائر؟";
  final String _correctAnswer = " شط ملغيغ";
