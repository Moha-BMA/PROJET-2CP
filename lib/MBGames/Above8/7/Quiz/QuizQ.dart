...
import 'dart:math';
import 'package:chainage1/MBGames/Above8/7/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "تعتبر الجزائر من اكبر المصدرين في العالم  ";
  final String _correctAnswer = " الغاز الطبيعي";
