...
import 'dart:math';
import 'package:chainage1/MBGames/Above8/15/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = " ما هو أحد السهول المهمة في الجزائر؟";
  final String _correctAnswer = " سهل متيجة";
