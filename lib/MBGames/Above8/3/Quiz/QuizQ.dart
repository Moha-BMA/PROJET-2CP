...
import 'dart:math';
import 'package:chainage1/MBGames/Above8/3/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أي من هذه الثقافات تعد ثقافة صحراوية؟";
  final String _correctAnswer = " بني مزاب";
