...
import 'dart:math';
import 'package:chainage1/MBGames/Above8/2/Settings.dart';
...
class _QuizQState extends State<QuizQ> with SingleTickerProviderStateMixin {
  ...
  // Question info
  final String _question = "أي من هذه الدول له حدود مع الجزائر غربا؟";
  final String _correctAnswer = " المغرب";
