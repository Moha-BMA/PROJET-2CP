import 'dart:math';
import 'package:chainage1/MBGames/Under7/2/Settings.dart';
  ...
  void _initializeGame() {
    ...
    List<CardData> pairs = [
      CardData(
        ...
        backImage: 'assets/assetsMBflipcard/Q2/1.png',
        pairId: 1,
      ),
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
      ...
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
        backImage: 'assets/assetsMBflipcard/Q2/2.png',
        pairId: 2,
      ),
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
      ...
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
        backImage: 'assets/assetsMBflipcard/Q2/3.png',
        pairId: 3,
      ),
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
      ...
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
        backImage: 'assets/assetsMBflipcard/Q4/4.png',
        pairId: 4,
      ),
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
