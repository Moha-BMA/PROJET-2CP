import 'dart:math';
import 'package:chainage1/MBGames/Under7/1/Settings.dart';
  ...
  void _initializeGame() {
    ...
    List<CardData> pairs = [
      CardData(
        ...
        backImage: 'assets/assetsMBflipcard/Q1/1.png',
        pairId: 1,
      ),
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
      ...
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
        backImage: 'assets/assetsMBflipcard/Q1/2.png',
        pairId: 2,
      ),
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
      ...
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
        backImage: 'assets/assetsMBflipcard/Q1/3.png',
        pairId: 3,
      ),
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
      ...
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
        backImage: 'assets/assetsMBflipcard/Q1/4.png',
        pairId: 4,
      ),
      CardData(
        frontImage: 'assets/assetsgames/assetsFlipCard/icons/fhead.png',
